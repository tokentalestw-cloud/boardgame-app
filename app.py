...
<form class="form-grid two" method="post" action="/records">
  ...
  <div style="grid-column:1/-1"><label>點選玩家</label><div class="choice-wrap">{member_chip_html}</div><input id="record_players" name="players" type="hidden" value=""><div class="preview-hint">可點選加入或取消，新增勝者區會跟著更新</div></div>
  <div style="grid-column:1/-1"><label>點選勝者</label><div class="choice-wrap">{winner_chip_html}</div><input id="record_winners" name="winners" type="hidden" value=""><div class="preview-hint">只有已選玩家會顯示在這裡</div></div>
